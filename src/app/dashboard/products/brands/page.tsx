...
import { BrandsTable } from "@/contexts/brands/presentation/components";
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div className="flex items-center gap-3 sm:gap-4">
        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-bee-gold/10">
          <Tag className="h-5 w-5 sm:h-6 sm:w-6 text-bee-gold" />
        </div>
        <div>
      ...
      >
        <Link href="/dashboard/products/brands/new">
...
export default function BrandsPage() {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      {/* Mobile FAB */}
      <Link
        href="/dashboard/products/brands/new"
