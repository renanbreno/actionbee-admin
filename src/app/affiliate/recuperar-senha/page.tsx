...
import { AffiliateForgotPasswordForm } from '@/contexts/affiliate-auth/presentation/components/affiliate-forgot-password-form';
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="rounded-2xl border bg-card p-6 shadow-sm">
          <AffiliateForgotPasswordForm
            onBack={() => router.push(affiliatePath('/login'))}
            onSuccess={() => {
