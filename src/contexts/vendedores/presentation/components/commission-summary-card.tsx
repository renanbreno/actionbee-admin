...
interface VendedorCommissionSummaryCardProps {
  summary: VendedorCommissionSummary;
  isLoading?: boolean;
  showCard?: boolean;
}

export function VendedorCommissionSummaryCard({ summary, isLoading, showCard = true }: VendedorCommissionSummaryCardProps) {
  const content = (
