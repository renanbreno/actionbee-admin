...
import { GetPayableByIdUseCase } from "./application/use-cases/get-payable-by-id.use-case";
...
import { BatchPayPayablesUseCase } from "./application/use-cases/batch-pay-payables.use-case";
import { BatchPayReceivablesUseCase } from "./application/use-cases/batch-pay-receivables.use-case";
...
export const getPayableByIdUseCase = new GetPayableByIdUseCase();
...
export const batchPayPayablesUseCase = new BatchPayPayablesUseCase();
export const batchPayReceivablesUseCase = new BatchPayReceivablesUseCase();
